...
try {
  ...
  if (baseline) {
    ...
    await page.getByRole('heading', { name: /^Rules ·/ }).waitFor()
    ...
    await page.locator('.desk-inspector').getByRole('heading', { name: 'Resolution · 2' }).waitFor()
    ...
    await page.getByRole('heading', { name: 'Sources · 0' }).waitFor()
    ...
    await tap.getByRole('heading', { name: /^Rules ·/ }).waitFor()
