 ...
 * `GET /api/session` — and that is what 7b's provider fills in. Nothing here
 * reads it: the state below is still decoded from the configuration, and a
 * provider that signed somebody in would still gate nothing until the PR that
 * wires it says otherwise in this comment.
 *
