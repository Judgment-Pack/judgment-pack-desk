/** Gateway catalog v2 fixture; no account, endpoint, credential, or display copy. */
export const connectionCatalogFixture = { version: 2, sources: [{ id: 'web', input: 'url', mediaTypes: ['text/html', 'text/plain', 'application/pdf'], maxBytes: 4 << 20 }], providers: [
