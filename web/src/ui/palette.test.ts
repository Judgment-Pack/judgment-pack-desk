...
const PAIRS: { front: string; back: string; least: number; why: string }[] = [
  ...
  { front: '--ink', back: '--sidebar', least: 4.5, why: 'selected navigation text' },
  ...
  { front: '--ink', back: '--accent-soft', least: 4.5, why: 'a chosen nav item' },
  { front: '--accent', back: '--accent-soft', least: 4.5, why: 'accent badge text' },
